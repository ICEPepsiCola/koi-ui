...
export interface ReceiptRefundIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ReceiptRefundIcon = React.forwardRef<SVGSVGElement, ReceiptRefundIconProps>(
