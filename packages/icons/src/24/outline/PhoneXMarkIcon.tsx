...
export interface PhoneXMarkIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const PhoneXMarkIcon = React.forwardRef<SVGSVGElement, PhoneXMarkIconProps>(
