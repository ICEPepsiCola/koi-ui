...
export interface DocumentCurrencyRupeeIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentCurrencyRupeeIcon = React.forwardRef<SVGSVGElement, DocumentCurrencyRupeeIconProps>(
