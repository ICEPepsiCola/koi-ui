...
export interface BookmarkSlashIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const BookmarkSlashIcon = React.forwardRef<SVGSVGElement, BookmarkSlashIconProps>(
