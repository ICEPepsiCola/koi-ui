...
export interface RocketLaunchIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const RocketLaunchIcon = React.forwardRef<SVGSVGElement, RocketLaunchIconProps>(
