...
export interface ArrowDownOnSquareStackIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowDownOnSquareStackIcon = React.forwardRef<SVGSVGElement, ArrowDownOnSquareStackIconProps>(
