...
export interface ServerStackIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ServerStackIcon = React.forwardRef<SVGSVGElement, ServerStackIconProps>(
