...
export interface PencilSquareIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const PencilSquareIcon = React.forwardRef<SVGSVGElement, PencilSquareIconProps>(
