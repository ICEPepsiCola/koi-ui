...
export interface ChatBubbleBottomCenterTextIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ChatBubbleBottomCenterTextIcon = React.forwardRef<SVGSVGElement, ChatBubbleBottomCenterTextIconProps>(
