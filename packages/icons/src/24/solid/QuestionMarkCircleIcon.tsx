...
export interface QuestionMarkCircleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const QuestionMarkCircleIcon = React.forwardRef<SVGSVGElement, QuestionMarkCircleIconProps>(
