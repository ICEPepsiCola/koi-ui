...
export interface BuildingLibraryIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const BuildingLibraryIcon = React.forwardRef<SVGSVGElement, BuildingLibraryIconProps>(
