...
export interface ViewfinderCircleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ViewfinderCircleIcon = React.forwardRef<SVGSVGElement, ViewfinderCircleIconProps>(
