...
export interface NumberedListIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const NumberedListIcon = React.forwardRef<SVGSVGElement, NumberedListIconProps>(
