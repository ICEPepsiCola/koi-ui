...
export interface DocumentArrowDownIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentArrowDownIcon = React.forwardRef<SVGSVGElement, DocumentArrowDownIconProps>(
