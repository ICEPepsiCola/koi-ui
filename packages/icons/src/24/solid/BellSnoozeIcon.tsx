...
export interface BellSnoozeIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const BellSnoozeIcon = React.forwardRef<SVGSVGElement, BellSnoozeIconProps>(
