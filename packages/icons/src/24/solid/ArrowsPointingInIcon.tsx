...
export interface ArrowsPointingInIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowsPointingInIcon = React.forwardRef<SVGSVGElement, ArrowsPointingInIconProps>(
