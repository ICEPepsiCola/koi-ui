...
export interface GlobeAsiaAustraliaIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const GlobeAsiaAustraliaIcon = React.forwardRef<SVGSVGElement, GlobeAsiaAustraliaIconProps>(
