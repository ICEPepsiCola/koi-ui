...
export interface DocumentCurrencyPoundIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentCurrencyPoundIcon = React.forwardRef<SVGSVGElement, DocumentCurrencyPoundIconProps>(
