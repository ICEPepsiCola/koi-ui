...
export interface ChatBubbleOvalLeftEllipsisIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ChatBubbleOvalLeftEllipsisIcon = React.forwardRef<SVGSVGElement, ChatBubbleOvalLeftEllipsisIconProps>(
