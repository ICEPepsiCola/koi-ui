...
export interface EllipsisHorizontalCircleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const EllipsisHorizontalCircleIcon = React.forwardRef<SVGSVGElement, EllipsisHorizontalCircleIconProps>(
