...
export interface SquaresPlusIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const SquaresPlusIcon = React.forwardRef<SVGSVGElement, SquaresPlusIconProps>(
