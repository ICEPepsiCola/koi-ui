...
export interface EyeDropperIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const EyeDropperIcon = React.forwardRef<SVGSVGElement, EyeDropperIconProps>(
