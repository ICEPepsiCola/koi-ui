...
export interface FingerPrintIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const FingerPrintIcon = React.forwardRef<SVGSVGElement, FingerPrintIconProps>(
