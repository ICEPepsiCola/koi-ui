...
export interface ClipboardDocumentIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ClipboardDocumentIcon = React.forwardRef<SVGSVGElement, ClipboardDocumentIconProps>(
