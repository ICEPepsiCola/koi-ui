...
export interface ArchiveBoxXMarkIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArchiveBoxXMarkIcon = React.forwardRef<SVGSVGElement, ArchiveBoxXMarkIconProps>(
