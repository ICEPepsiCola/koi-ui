...
export interface ChatBubbleOvalLeftIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ChatBubbleOvalLeftIcon = React.forwardRef<SVGSVGElement, ChatBubbleOvalLeftIconProps>(
