...
export interface ArrowUpCircleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowUpCircleIcon = React.forwardRef<SVGSVGElement, ArrowUpCircleIconProps>(
