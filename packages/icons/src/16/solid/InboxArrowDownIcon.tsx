...
export interface InboxArrowDownIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const InboxArrowDownIcon = React.forwardRef<SVGSVGElement, InboxArrowDownIconProps>(
