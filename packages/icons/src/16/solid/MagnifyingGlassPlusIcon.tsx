...
export interface MagnifyingGlassPlusIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const MagnifyingGlassPlusIcon = React.forwardRef<SVGSVGElement, MagnifyingGlassPlusIconProps>(
