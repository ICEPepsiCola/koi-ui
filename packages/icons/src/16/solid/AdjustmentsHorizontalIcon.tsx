...
export interface AdjustmentsHorizontalIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const AdjustmentsHorizontalIcon = React.forwardRef<SVGSVGElement, AdjustmentsHorizontalIconProps>(
