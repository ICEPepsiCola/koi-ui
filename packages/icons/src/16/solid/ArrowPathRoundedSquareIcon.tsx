...
export interface ArrowPathRoundedSquareIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowPathRoundedSquareIcon = React.forwardRef<SVGSVGElement, ArrowPathRoundedSquareIconProps>(
