...
export interface DocumentCurrencyBangladeshiIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentCurrencyBangladeshiIcon = React.forwardRef<SVGSVGElement, DocumentCurrencyBangladeshiIconProps>(
