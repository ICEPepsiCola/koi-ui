...
export interface DocumentDuplicateIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentDuplicateIcon = React.forwardRef<SVGSVGElement, DocumentDuplicateIconProps>(
