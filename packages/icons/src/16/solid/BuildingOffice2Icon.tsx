...
export interface BuildingOffice2IconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const BuildingOffice2Icon = React.forwardRef<SVGSVGElement, BuildingOffice2IconProps>(
