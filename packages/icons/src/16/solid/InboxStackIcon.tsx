...
export interface InboxStackIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const InboxStackIcon = React.forwardRef<SVGSVGElement, InboxStackIconProps>(
