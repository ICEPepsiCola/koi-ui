...
export interface CalculatorIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const CalculatorIcon = React.forwardRef<SVGSVGElement, CalculatorIconProps>(
