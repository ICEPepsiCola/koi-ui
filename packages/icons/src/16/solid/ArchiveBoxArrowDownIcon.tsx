...
export interface ArchiveBoxArrowDownIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArchiveBoxArrowDownIcon = React.forwardRef<SVGSVGElement, ArchiveBoxArrowDownIconProps>(
