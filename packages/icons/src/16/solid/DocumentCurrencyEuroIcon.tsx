...
export interface DocumentCurrencyEuroIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentCurrencyEuroIcon = React.forwardRef<SVGSVGElement, DocumentCurrencyEuroIconProps>(
