...
export interface ArrowDownTrayIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowDownTrayIcon = React.forwardRef<SVGSVGElement, ArrowDownTrayIconProps>(
