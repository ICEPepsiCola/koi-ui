...
export interface TableCellsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const TableCellsIcon = React.forwardRef<SVGSVGElement, TableCellsIconProps>(
