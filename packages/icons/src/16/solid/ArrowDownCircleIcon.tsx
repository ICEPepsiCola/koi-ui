...
export interface ArrowDownCircleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowDownCircleIcon = React.forwardRef<SVGSVGElement, ArrowDownCircleIconProps>(
