...
export interface PhoneArrowDownLeftIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const PhoneArrowDownLeftIcon = React.forwardRef<SVGSVGElement, PhoneArrowDownLeftIconProps>(
