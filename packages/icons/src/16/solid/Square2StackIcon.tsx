...
export interface Square2StackIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const Square2StackIcon = React.forwardRef<SVGSVGElement, Square2StackIconProps>(
