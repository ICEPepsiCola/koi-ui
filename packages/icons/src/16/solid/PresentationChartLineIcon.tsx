...
export interface PresentationChartLineIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const PresentationChartLineIcon = React.forwardRef<SVGSVGElement, PresentationChartLineIconProps>(
