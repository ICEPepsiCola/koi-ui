...
export interface Squares2x2IconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const Squares2x2Icon = React.forwardRef<SVGSVGElement, Squares2x2IconProps>(
