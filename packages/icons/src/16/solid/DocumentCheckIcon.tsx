...
export interface DocumentCheckIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentCheckIcon = React.forwardRef<SVGSVGElement, DocumentCheckIconProps>(
