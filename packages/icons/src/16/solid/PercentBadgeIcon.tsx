...
export interface PercentBadgeIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const PercentBadgeIcon = React.forwardRef<SVGSVGElement, PercentBadgeIconProps>(
