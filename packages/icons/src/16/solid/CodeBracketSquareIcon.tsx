...
export interface CodeBracketSquareIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const CodeBracketSquareIcon = React.forwardRef<SVGSVGElement, CodeBracketSquareIconProps>(
