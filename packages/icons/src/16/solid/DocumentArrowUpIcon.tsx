...
export interface DocumentArrowUpIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentArrowUpIcon = React.forwardRef<SVGSVGElement, DocumentArrowUpIconProps>(
