...
export interface DocumentCurrencyYenIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentCurrencyYenIcon = React.forwardRef<SVGSVGElement, DocumentCurrencyYenIconProps>(
