...
export interface ChatBubbleLeftRightIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ChatBubbleLeftRightIcon = React.forwardRef<SVGSVGElement, ChatBubbleLeftRightIconProps>(
