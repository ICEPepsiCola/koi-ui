...
export interface ArrowsPointingOutIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowsPointingOutIcon = React.forwardRef<SVGSVGElement, ArrowsPointingOutIconProps>(
