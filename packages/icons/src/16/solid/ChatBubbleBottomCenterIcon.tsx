...
export interface ChatBubbleBottomCenterIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ChatBubbleBottomCenterIcon = React.forwardRef<SVGSVGElement, ChatBubbleBottomCenterIconProps>(
