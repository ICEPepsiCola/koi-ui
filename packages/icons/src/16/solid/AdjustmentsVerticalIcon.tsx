...
export interface AdjustmentsVerticalIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const AdjustmentsVerticalIcon = React.forwardRef<SVGSVGElement, AdjustmentsVerticalIconProps>(
