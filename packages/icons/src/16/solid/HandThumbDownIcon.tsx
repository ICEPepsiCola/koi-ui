...
export interface HandThumbDownIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const HandThumbDownIcon = React.forwardRef<SVGSVGElement, HandThumbDownIconProps>(
