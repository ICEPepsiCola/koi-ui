...
export interface DocumentCurrencyDollarIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentCurrencyDollarIcon = React.forwardRef<SVGSVGElement, DocumentCurrencyDollarIconProps>(
