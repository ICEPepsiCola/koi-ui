...
export interface SpeakerWaveIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const SpeakerWaveIcon = React.forwardRef<SVGSVGElement, SpeakerWaveIconProps>(
