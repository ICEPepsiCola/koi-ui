...
export interface ArrowRightStartOnRectangleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowRightStartOnRectangleIcon = React.forwardRef<SVGSVGElement, ArrowRightStartOnRectangleIconProps>(
