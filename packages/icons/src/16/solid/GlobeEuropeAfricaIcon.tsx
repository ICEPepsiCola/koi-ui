...
export interface GlobeEuropeAfricaIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const GlobeEuropeAfricaIcon = React.forwardRef<SVGSVGElement, GlobeEuropeAfricaIconProps>(
