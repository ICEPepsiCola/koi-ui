...
export interface MagnifyingGlassMinusIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const MagnifyingGlassMinusIcon = React.forwardRef<SVGSVGElement, MagnifyingGlassMinusIconProps>(
