...
export interface Square3Stack3dIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const Square3Stack3dIcon = React.forwardRef<SVGSVGElement, Square3Stack3dIconProps>(
