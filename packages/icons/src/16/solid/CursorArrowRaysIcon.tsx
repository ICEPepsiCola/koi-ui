...
export interface CursorArrowRaysIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const CursorArrowRaysIcon = React.forwardRef<SVGSVGElement, CursorArrowRaysIconProps>(
