...
export interface RectangleStackIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const RectangleStackIcon = React.forwardRef<SVGSVGElement, RectangleStackIconProps>(
