...
export interface CurrencyBangladeshiIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const CurrencyBangladeshiIcon = React.forwardRef<SVGSVGElement, CurrencyBangladeshiIconProps>(
