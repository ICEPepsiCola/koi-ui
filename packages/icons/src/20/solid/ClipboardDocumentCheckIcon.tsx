...
export interface ClipboardDocumentCheckIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ClipboardDocumentCheckIcon = React.forwardRef<SVGSVGElement, ClipboardDocumentCheckIconProps>(
