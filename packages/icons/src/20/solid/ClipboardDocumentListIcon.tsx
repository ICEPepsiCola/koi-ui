...
export interface ClipboardDocumentListIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ClipboardDocumentListIcon = React.forwardRef<SVGSVGElement, ClipboardDocumentListIconProps>(
