...
export interface ChatBubbleLeftEllipsisIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ChatBubbleLeftEllipsisIcon = React.forwardRef<SVGSVGElement, ChatBubbleLeftEllipsisIconProps>(
