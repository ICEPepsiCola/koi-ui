...
export interface CursorArrowRippleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const CursorArrowRippleIcon = React.forwardRef<SVGSVGElement, CursorArrowRippleIconProps>(
