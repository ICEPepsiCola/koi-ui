...
export interface HomeModernIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const HomeModernIcon = React.forwardRef<SVGSVGElement, HomeModernIconProps>(
