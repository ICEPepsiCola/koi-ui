...
export interface ArrowLeftEndOnRectangleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowLeftEndOnRectangleIcon = React.forwardRef<SVGSVGElement, ArrowLeftEndOnRectangleIconProps>(
