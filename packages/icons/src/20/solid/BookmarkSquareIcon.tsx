...
export interface BookmarkSquareIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const BookmarkSquareIcon = React.forwardRef<SVGSVGElement, BookmarkSquareIconProps>(
