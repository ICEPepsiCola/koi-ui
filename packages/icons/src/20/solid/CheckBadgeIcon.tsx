...
export interface CheckBadgeIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const CheckBadgeIcon = React.forwardRef<SVGSVGElement, CheckBadgeIconProps>(
