...
export interface BuildingStorefrontIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const BuildingStorefrontIcon = React.forwardRef<SVGSVGElement, BuildingStorefrontIconProps>(
