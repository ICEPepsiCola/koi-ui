...
export interface ArrowUpOnSquareStackIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowUpOnSquareStackIcon = React.forwardRef<SVGSVGElement, ArrowUpOnSquareStackIconProps>(
