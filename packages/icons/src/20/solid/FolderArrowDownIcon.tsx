...
export interface FolderArrowDownIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const FolderArrowDownIcon = React.forwardRef<SVGSVGElement, FolderArrowDownIconProps>(
