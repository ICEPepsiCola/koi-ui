...
export interface CommandLineIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const CommandLineIcon = React.forwardRef<SVGSVGElement, CommandLineIconProps>(
