...
export interface CubeTransparentIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const CubeTransparentIcon = React.forwardRef<SVGSVGElement, CubeTransparentIconProps>(
