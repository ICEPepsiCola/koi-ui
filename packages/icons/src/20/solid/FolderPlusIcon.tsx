...
export interface FolderPlusIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const FolderPlusIcon = React.forwardRef<SVGSVGElement, FolderPlusIconProps>(
