...
export interface IdentificationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const IdentificationIcon = React.forwardRef<SVGSVGElement, IdentificationIconProps>(
