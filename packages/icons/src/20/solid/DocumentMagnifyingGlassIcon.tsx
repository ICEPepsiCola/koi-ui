...
export interface DocumentMagnifyingGlassIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentMagnifyingGlassIcon = React.forwardRef<SVGSVGElement, DocumentMagnifyingGlassIconProps>(
