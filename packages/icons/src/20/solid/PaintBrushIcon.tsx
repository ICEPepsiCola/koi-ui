...
export interface PaintBrushIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const PaintBrushIcon = React.forwardRef<SVGSVGElement, PaintBrushIconProps>(
