...
export interface ReceiptPercentIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ReceiptPercentIcon = React.forwardRef<SVGSVGElement, ReceiptPercentIconProps>(
