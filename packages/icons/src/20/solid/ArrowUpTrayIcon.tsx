...
export interface ArrowUpTrayIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ArrowUpTrayIcon = React.forwardRef<SVGSVGElement, ArrowUpTrayIconProps>(
