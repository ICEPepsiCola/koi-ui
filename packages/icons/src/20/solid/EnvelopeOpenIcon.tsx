...
export interface EnvelopeOpenIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const EnvelopeOpenIcon = React.forwardRef<SVGSVGElement, EnvelopeOpenIconProps>(
