...
export interface DocumentPlusIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const DocumentPlusIcon = React.forwardRef<SVGSVGElement, DocumentPlusIconProps>(
