...
export interface CircleStackIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const CircleStackIcon = React.forwardRef<SVGSVGElement, CircleStackIconProps>(
