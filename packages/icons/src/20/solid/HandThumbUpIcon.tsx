...
export interface HandThumbUpIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const HandThumbUpIcon = React.forwardRef<SVGSVGElement, HandThumbUpIconProps>(
