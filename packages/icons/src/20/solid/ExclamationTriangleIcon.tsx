...
export interface ExclamationTriangleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ExclamationTriangleIcon = React.forwardRef<SVGSVGElement, ExclamationTriangleIconProps>(
