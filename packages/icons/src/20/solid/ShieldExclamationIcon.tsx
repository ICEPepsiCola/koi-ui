...
export interface ShieldExclamationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
}

export const ShieldExclamationIcon = React.forwardRef<SVGSVGElement, ShieldExclamationIconProps>(
